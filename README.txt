...
Data_preprocessing.py: Prepares the data for training and testing the models.
Data_preprocessing_plots.py: Produces plots for data analysis.
RF_model.py: Trains and evaluates the Random Forest model.
NN_model.py: Trains and evaluates the Neural Network model.
...
In order to run the models and thus have the results of the predicted temperatures in a .csv file please, this procedure:
1. Dowload the codes and the data and make a folder with all of them
